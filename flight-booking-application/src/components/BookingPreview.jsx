import { remove } from "../redux/flightBooking/actions";

export default function BookingPreview({ booking, dispatch }) {
  // remove a booking
  const removeBook = (id) => {
    dispatch(remove(id));
  };
          ...
          <tbody className="divide-y divide-gray-300/20" id="lws-previewBooked">
            ...
            {booking.map((book) => (
              <tr key={book.id} className="lws-bookedTable text-black">
                ...
                <td className="px-6 py-4 text-center">
                  <span className="lws-bookedclassName">{book.className}</span>
                </td>
                <td className="px-6 py-4 text-center">
